                    ...
                    <DataTable paginator :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]" class="flex1 flex-column"
                        ...
                        <Column style="width: 100px;" header="Thao tác" frozen="" alignFrozen="right">
                            <template #body="{ slotProps, index, data }">
                                <div class="row-actions" :ref="`busstop${index}`" @dblclick.stop="unDbl" v-if="!isLoading">
                ...
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <Dropdown :options="sheetOptions" optionLabel="sheetName" optionValue="sheetIndex"
                            ...
                            v-model="selectedData.SheetIndexReference" dropdownIcon="icon-combo--dropdown dropdown-list" />
                ...
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <InputNumber v-model="selectedData.RowReference" ref="RowReference" showButtons :min="1"
                            :class="{ 'error': invalidData['RowReference'] }" :max-fraction-digits="5" :max="100" />
...
import ExamPopup from '../components/exam-bank/ExamPopup.vue';
import ExamSetup from '../components/exam-bank/ExamSetup.vue';
...
import { deleteExamBank, getExamBank, updateExamBank } from '../../api/exambank';
export default {
    directives: {

<template>
                                ...
                                <div class="content-body flex1 flex-column">
                                            ...
                                            <div class="flex1 mr-10">
                                                ...
                                                <div class="ms-input ms-editor w-100">
                                                    <Calendar v-model="exam.ExamEndDate" dateFormat="dd/mm/yy"
                                                        ...
                                                        :minDate="exam.ExamStartDate" :disabled="exam.ExamStartDate == null"
                                    ...
                                    <div class="mb-20 flex-column flex1">
                                        ...
                                        <div class="d-flex w-100 mb-10">
                                            <div class="flex1"><span class="error-text">{{ invalidExamManager['ExamShift']
                                            }}</span></div>
    ...
    <Dialog v-model:visible="examShiftDialogVisible" modal @keydown.enter.prevent="saveExamShift"
        @afterHide="afterHideExamShiftDialog" :header="modeExamShiftModal == FormMode.Insert ? 'Thêm ca thi' : 'Sửa ca thi'"
        :style="{ width: '50vw' }">
        ...
        <div class="w-full flex flex-column">
            ...
            <div class="form-group flex-row">
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <Calendar locale="vi" dateFormat="dd/mm/yy" :class="{ 'error': invalidExamShift['DateTimeStart'] }"
                            v-model="selectedExamShift.DateTimeStart" :min="exam.ExamStartDate" :max-date="exam.ExamEndDate"
                ...
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <Calendar dateFormat="dd/mm/yy" :class="{ 'error': invalidExamShift['DateTimeEnd'] }"
                            ...
                            :disabled="selectedExamShift.DateTimeStart == null" v-model="selectedExamShift.DateTimeEnd"
                            id="calendar-24h" placeholder="Chọn ngày kết thúc kì thi" showTime hourFormat="24" showIcon />
                ...
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <MultiSelect v-model="selectedExamShift.Department"
                            ...
                            placeholder="Chọn phòng thi" optionLabel="DepartmentName" optionValue="DepartmentId" />
                ...
                <div class="flex1 mr-10">
                    ...
                    <div class="ms-input ms-editor w-100">
                        <MultiSelect v-model="selectedExamShift.ExamBankId" :options="examBankSetting" checkboxIcon="test"
    ...
    <Dialog v-model:visible="isPopupDelete" modal closeOnEscape :style="{ width: '25vw' }" header="Xóa kì thi">
        ...
        <div class="w-full flex flex-column" style="line-height: 1.5;">
            <span>Ca thi <b>{{
                selectedExamShift.ExamShiftCode }}</b> có thể liên quan đến kết quả các bài thi. Bạn có chắc chắn muốn
                xóa
                không?</span>
        </div>
        <template #footer>
...
import { saveExamManager, checkExamShiftCodeExits, updateExamShift, updateExamManager, insertExamShift, getExamShift, deleteExamShift } from '../../../api/exammanager';
                ...
                switch (this.modeModal) {
                    ...
                    case this.FormMode.Update:
                        switch (this.modeExamShiftModal) {
                            ...
                            case this.FormMode.Insert:
                                var success = false;
                                insertExamShift({ ...this.selectedExamShift, ExamId: this.selectedDataProp.ExamId }).then(res => {
                                    success = true;
                                }).catch(error => {
                                    console.log(error);
                                }).finally(() => {
        ...
        */
        ...
        async validateExamShift() {
            ...
            if (valObj.length && this.modeExamShiftModal !== this.FormMode.Update) {
                ...
                //gọi api kiểm tra mã
                await checkExamShiftCodeExits({ data: this.selectedExamShift, mode: this.modeExamShiftModal }).then(res => {
                    if (res.result) {
                        this.invalidExamShift['ExamShiftCode'] = 'Mã ca thi đã tồn tại';
                        invalid = false;
                    }

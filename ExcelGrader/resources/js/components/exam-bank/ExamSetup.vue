                                        ...
                                        <div class="flex-row">
                                                ...
                                                <div class="form-group slide-detail">
                                                    ...
                                                    <div class="flex1">
                                                        <Dropdown v-model="Format.SheetIndex" optionLabel="sheetName"
                                                            ...
                                                            optionValue="sheetIndex" :options="optionSheet" showClear
                                            ...
                                            <div class="flex1">
                                                <div class="form-group slide-detail">
                                                    ...
                                                    <div class="error-text" v-if="invalidData[`range${this.tabViewIndex}`]">
                                                ...
                                                <div class="flex-row">
                                                    <div class="flex1">
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.Font.content" showClear
                                                                    editable
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <InputNumber v-model="Format.Property.Font.point"
                                                                    ...
                                                                    :maxFractionDigits="5" placeholder="Enter your point"
                                                                    class="ms-point" />
                                                            </div>
                                                            <div class="error-text"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.FontStyle.content"
                                                                    ...
                                                                    optionLabel="description" optionValue="value" editable
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown :type-property="TypeProperty.FontUnderline"
                                                                    property-name="Font Underline" class="ms-format"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.Horizontal.content"
                                                                    property-name="Text Horizontal" class="ms-format"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.Vertical.content"
                                                                    property-name="Text Vertical" class="ms-format"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <InputNumber v-model="Format.Property.Vertical.point"
                                                                    :min="0" :max="100" :max-fraction-digits="5"
                                                                    placeholder="Enter your point" class="ms-point" />
                                                            </div>
                                                            <div class="error-text"
                                                                v-if="invalidData[`point${TypeProperty.Vertical}`]">
                                                    ...
                                                    <div class="form-group slide-detail"
                                                        ...
                                                        <div class="flex1">
                                                            <InputNumber v-model="Format.Property.FormatNumber.decimal"
                                                                ...
                                                                :maxFractionDigits="5" placeholder="Enter your Deciaml" />
                                                        </div>
                                                ...
                                                <div class="flex-row">
                                                    <div class="flex1">
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <InputNumber v-model="Format.Property.ColumnWidth.content"
                                                ...
                                                <div class="flex-row">
                                                    <div class="flex1">
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.FormatAsTable.content"
                                                                    showClear
                                                    ...
                                                    <div class="flex1">
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <InputNumber v-model="Format.Property.FormatAsTable.point"
                                                                    :max-fraction-digits="5" :min="0" :max="100"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <InputNumber v-model="Format.Property.TableName.point"
                                                                    ...
                                                                    placeholder="Enter your point" :maxFractionDigits="5"
                                                                    class="ms-point" />
                                                            </div>
                                                            <div class="error-text"
                                                        ...
                                                        <div class="form-group slide-detail">
                                                            ...
                                                            <div class="flex1">
                                                                <Dropdown v-model="Format.Property.TableStyle.content"
                                                                    ...
                                                                    :options="configureExamData.TableStyles" showClear
                                                                    optionLabel="description" optionValue="value" editable
                                                    ...
                                                    <div class="form-group slide-detail">
                                                        ...
                                                        <div class="flex1">
                                                            <Dropdown v-model="Text.SheetIndex" optionLabel="sheetName"
                                                                ...
                                                                :type-property="TypeProperty.Text" optionValue="sheetIndex"
                                                            ...
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="AdvancedFilter.Range"
                                                                        ...
                                                                        class="heigth36" placeholder="Enter your range" />
                                                                </div>
                                                                <div class="error-text"
                                                            ...
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="AdvancedFilter.DataRange"
                                                                        ...
                                                                        @keypress="validateInputRangeNoRef" class="heigth36"
                                                                        placeholder="Enter your range" />
                                                                </div>
                                                                <div class="error-text"
                                                    ...
                                                    <div class="flex-row">
                                                        ...
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="AdvancedFilter.TitleRange[index]"
                                                                        @keypress="validateInputRangeNoRef"
                                                        ...
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="AdvancedFilter.TitleContent[index]"
                                                        ...
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="AdvancedFilter.CriteriaRange[index]"
                                            ...
                                            <div class="flex-row">
                                                <div class="flex1">
                                                    <div class="form-group slide-detail">
                                                        ...
                                                        <div class="flex1">
                                                            <InputNumber v-model="AdvancedFilter.Point" :min="0" :max="100"
                                                                :max-fraction-digits="5"
                                                                :class="{ 'error': invalidData['PointAdvancedFilter'] }"
                                                                placeholder="Enter your Content" />
                                                        </div>
                                                        <div class="error-text" v-if="invalidData['PointAdvancedFilter']">
                                            ...
                                            <div class="flex-row">
                                                <div class="flex1">
                                                    <div class="form-group slide-detail">
                                                        ...
                                                        <div class="flex1">
                                                            <Dropdown v-model="Formula.SheetIndex" optionLabel="sheetName"
                                                                showClear
                                                            ...
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <Dropdown
                                                                        ...
                                                                        editable placeholder="Select a Page Orientation" />
                                                                </div>
                                                                <div class="error-text"
                                                    ...
                                                    <div class="flex-row">
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <Dropdown v-model="General.Property.PageSize.Content"
                                                        ...
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputNumber v-model="General.Property.PageSize.Point"
                                                                        :max-fraction-digits="5"
                                                                        :class="{ 'error': invalidData['pointPageSize'] }"
                                                                        placeholder="Enter your point" class="ms-point" />
                                                                </div>
                                                                <div class="error-text" v-if="invalidData['pointPageSize']">
                                            ...
                                            <div class="flex-row" v-for="item, index in optionSheet">
                                                ...
                                                <div class="flex1">
                                                    <div class="form-group slide-detail">
                                                        ...
                                                        <div class="error-text" v-if="invalidData[`typeSheetName${index}`]">
                                                ...
                                                <div class="flex1">
                                                    <div class="form-group slide-detail">
                                                        ...
                                                        <div class="flex1">
                                                            <InputNumber v-model="General.SheetName.Point[index]" :min="0"
                                                    ...
                                                    <div class="flex-row">
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputText v-model="General.Property.FileName.Content"
                                                        ...
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="flex1">
                                                                    <InputNumber v-model="General.Property.FileName.Point"
                                                                        :class="{ 'error': invalidData[`pointFileName`] }"
                                                                        :maxFractionDigits="5" :min="0"
                                                                        placeholder="Enter your point" />
                                                                </div>
                                                                <div class="error-text" v-if="invalidData[`pointFileName`]">
                                                    ...
                                                    <div class="flex-row">
                                                        <div class="flex1">
                                                            <div class="form-group slide-detail">
                                                                ...
                                                                <div class="error-text" v-if="invalidData['contentInfo']">
        ...
        <div class="ms-grid-viewer flex1 flex-box flex-column">
            <div class="ms-content--table flex-column flex1">
                <DataTable paginator :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]" class="flex1 flex-column"
                    :class="{ 'loading': isLoading }" :loading="isLoading" :value="isLoading ? Array.from({ length: 8 }, () => ({ ...{} })) : listCriteria" table-class="grid-group"
...
import { configureExam, saveCriteria, getCriteriaByExamBankId, deleteCriteria } from '../../../api/exambank'
import * as Coordinate from '../../common/Coordinate'
        ...
        saveCriteriaSettings() {
            ...
            if (this.tabViewIndex == 0) {
                ...
                if (Object.keys(this.invalidData).length > 0) {
                    this.scrollViewToId('scrollToFormat'); return;
                }
...
<style scoped>
@import url('../../../../public/css/components/exam-setup.css');
</style>
